...
class QSBK:
    ...
    def __init__(self):
        self.pageIndex = 1
        self.user_agent = 'User-Agent:Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/62.0.3202.94 Safari/537.36'
        # 初始化headers
    ...
    def getPage(self, pageIndex):
        try:
            url = 'https://www.qiushibaike.com/8hr/page/' + str(pageIndex) + '/?s=4947636'
            # 构建请求的request
